...
function pixith_field_pill_cb( $args ) {
 // get the value of the setting weve registered with register_setting()
 $options = get_option( 'pixith_options' );
 // output the field
 ?>
 <select id="<?php echo esc_attr( $args['label_for'] ); ?>" data-custom="<?php echo esc_attr( $args['pixith_custom_data'] ); ?>" name="pixith_options[<?php echo esc_attr( $args['label_for'] ); ?>]">
